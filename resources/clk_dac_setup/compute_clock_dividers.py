...
if __name__ == "__main__":
    ...
    bclk_48khz = float(mclk_khz) / 8
    [bclk_48khz, bclk_48khz_div_i, bclk_48khz_div_f] = compute_dividers(args.source_clock_khz, bclk_48khz)

    bclk_16khz = mclk_khz / 24
    [bclk_16khz, bclk_16khz_div_i, bclk_16khz_div_f] = compute_dividers(args.source_clock_khz, bclk_16khz)
    ...
    print(f"\tBCLK at 48kHz: freq {bclk_48khz}kHz CLK_I {bclk_48khz_div_i} CLK_F {bclk_48khz_div_f}")
    print(f"\tBCLK at 16kHz: freq {bclk_16khz}kHz CLK_I {bclk_16khz_div_i} CLK_F {bclk_16khz_div_f}")
